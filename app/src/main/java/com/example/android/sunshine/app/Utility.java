...
public class Utility {
    ...
    /**
     * Returns an asset to be attached to a data item for wearables
     *
     * @param bitmap The image resource to be sent to the wearable
     * @return asset to be attached to a data item
     */
